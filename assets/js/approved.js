  ...
  $(document).ready(function () {
      ...
      $.ajax({
        url: app_url+'index.php/service_orders_controller/get_all_approved_data',
        type: 'POST',  
      })
          .done(function(data) {
    ...
    $("#myModal").addClass('approved_orders');
    ...
    .done(function(data) {
      ...
      if (output.status == 200) {
        ...
        $('.approved_orders #service_order_no').html(output.data.service_order_no);
        $('.approved_orders #order_date').html(output.data.order_date);
        $('.approved_orders #first_name').html(output.data.first_name);
        $('.approved_orders #last_name').html(output.data.last_name);
        $('.approved_orders #contact_no').html(output.data.contact_no);
        $('.approved_orders #machine_model').html(output.data.machine_model);
        $('.approved_orders #serial_no').html(output.data.serial_no); 
        $('.approved_orders #accessories').html(output.data.accessories);  
        $('.approved_orders #remarks').html(output.data.remarks);  
        $('.approved_orders #status').html(output.data.status); 
